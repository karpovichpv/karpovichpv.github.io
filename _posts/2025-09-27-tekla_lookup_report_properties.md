...
Обновил [свою утилиту для Tekla Structures](https://github.com/karpovichpv/Lookup) до версии 3.1. Основным мотивом было желание отобразить всевозможные значения ReportProperty для объекта ModelObject. Т.к. когда настраиваешь tpl шаблон или создаешь свою метку на основе шаблона далеко не всегда очевидно, какое свойство нужно записать, чтобы получить нужный результат. Ближе к делу:
...
Скачиваем обновлённый TSEP из [релизов гитхаба](https://github.com/karpovichpv/Lookup/releases/tag/v.3.1)